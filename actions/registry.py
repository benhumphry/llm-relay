...
def get_system_prompt_for_actions(
    ...
    lines = [
        ...
        "",
        "IMPORTANT RULES:",
        "- When the user asks you to perform an action (send email, create event, complete task, etc.), YOU MUST include a <smart_action> block",
        "- NEVER say 'I have completed/marked/done X' without including the <smart_action> block - the action only happens if you include the block!",
        "- If you don't include the <smart_action> block, NOTHING HAPPENS - do not lie to the user",
